...
class TimeTestCase(APITestCase):
    ...
    def test_time_is_valid(self):
        ...
        self.assertEqual(moscow_time_from_api.hour, moscow_time_from_test.hour, f"Time is invalid")
        self.assertEqual(moscow_time_from_api.day, moscow_time_from_test.day, f"Time is invalid")
